...
EXAMPLES_PORT ?= 8080
TEST_BASE_IMAGE ?= serpensin/astraeus-obfuscator-test-base:latest
TEST_IMAGE ?= astraeus-obfuscator:test
...
test:
	...
	docker run --rm --name astraeus-obfuscator-tests $(TEST_IMAGE)
