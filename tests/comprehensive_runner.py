...
SRC = ROOT / "src"
GMOD_DIR = Path("/opt/gmod/garrysmod/data/astraeus_tests")
GMOD_EXE = Path("/opt/gmod/srcds_run")
GMOD_LOG = Path("/tmp/astraeus-gmod.log")

HTTP_TIMEOUT = 30
GMOD_STARTUP_TIMEOUT = 180
GMOD_FILE_TIMEOUT = 20
GMOD_POLL_INTERVAL = 0.05
NUM_WORKERS = int(os.getenv("ASTRAEUS_TEST_WORKERS", "16"))
...
def obfuscate(lang_name, lang_config, combo):
    ...
    command = ["lua5.4", "astraeus.lua", str(path), "--target", lang_name]
