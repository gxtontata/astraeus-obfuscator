...
def main():
    ...
    fixture = sys.argv[1]
    workers = max(1, int(os.getenv("ASTRAEUS_LUA_TEST_WORKERS", str(os.cpu_count() or 1))))
    chunk_size = max(1, int(os.getenv("ASTRAEUS_LUA_TEST_CHUNK_SIZE", "64")))
    ...
    with tempfile.TemporaryDirectory(prefix="astraeus-fixture-sweep-") as tmp:
        tmpdir = Path(tmp)
