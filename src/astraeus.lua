...
local function printCliResult(input, output, time, options)
    ...
    if options.sanity_check then
        if options.sanity_failed then
            ...
            print(colors.red .. "Please dm 'shitzusqualo' on Discord with with the file, or make an issue on the GitHub" .. colors.reset)
...
local function printUsage()
    print(colors.white .. "Usage: " .. colors.reset .. colors.cyan .. "./astraeus.lua *.lua (+ any options)" .. colors.reset)
